...
pub const SEC_TICKERS: &[(&str, &str)] = &[
    ...
    ("AGNPD", "Algernon Health Inc."),
    ("AGNPF", "Algernon Health Inc."),
    ...
    ("ALOG", "ALBERT ORIGIN ACQUISITION Corp"),
    ...
    ("AMPWF", "Ardagh Metal Packaging S.A."),
    ...
    ("APADR", "AParadise Acquisition Corp."),
    ("APADU", "AParadise Acquisition Corp."),
    ("APAM", "Artisan Partners Asset Management Inc."),
    ("APAT", "AsiaPac AdTechinno Group Ltd"),
    ("APC", "ARKO Petroleum Corp."),
    ("APCX", "AppTech Payments Corp."),
    ("APCXW", "AppTech Payments Corp."),
    ("APD", "Air Products & Chemicals, Inc."),
    ("APEI", "AMERICAN PUBLIC EDUCATION INC"),
    ("APEX", "APEX Global Solutions Ltd"),
    ("APG", "APi Group Corp"),
    ...
    ("APN", "APEIRON ACQUISITION VEHICLE I"),
    ...
    ("BCAB", "BioAtla, Inc."),
    ("BCAC", "Brookline Capital Acquisition Corp II"),
    ("BCAEF", "BCE INC"),
    ...
    ("BGHL", "BILLION GROUP HOLDINGS Ltd"),
    ("BGI", "BIRKS GROUP INC."),
    ...
    ("BKKT", "Bakkt, Inc."),
    ("BKKT-WT", "Bakkt, Inc."),
    ("BKLPF", "PT Bukalapak.com Tbk/ADR"),
    ...
    ("BLD", "TopBuild Corp"),
    ("BLDC", "Blockfusion Data Centers, Inc."),
    ...
    ("BLMZF", "Harrison Global Holdings Inc."),
    ...
    ("BRELY", "Brazilian Rare Earths Limited/ADR"),
    ("BRETF", "Brazilian Rare Earths Limited/ADR"),
    ...
    ("BTFT", "Beta FinTech Holdings Ltd"),
    ("BTG", "B2GOLD CORP"),
    ...
    ("BUHHF", "Bumrungrad Hospital Public Co Limited/ADR"),
    ...
    ("BWGC", "BW Industrial Holdings Inc."),
    ...
    ("CBSTQ", "Cannabist Co Holdings Inc."),
    ("CBT", "CABOT CORP"),
    ...
    ("CFLAS", "Cityfunds I, LLC"),
    ("CFNB", "CALIFORNIA FIRST LEASING CORP"),
    ("CFND", "C1 Fund Inc."),
    ("CFNHS", "Cityfunds I, LLC"),
    ...
    ("CJMB", "CALLAN JMB INC."),
    ("CKDXF", "Opthea Ltd"),
    ("CKHGF", "Capitec Bank Holdings Ltd / ADR"),
    ("CKX", "CKX LANDS, INC."),
    ...
    ("CMIIU", "Columbus Circle Capital Corp II"),
    ...
    ("CNTMD", "ConnectM Technology Solutions, Inc."),
    ("CNTMF", "Fluent Corp."),
    ...
    ("CTDD", "QWEST CORP"),
    ("CTEV", "Claritev Corp"),
    ("CTFDS", "Cityfunds I, LLC"),
    ("CTFMS", "Cityfunds I, LLC"),
    ("CTFPS", "Cityfunds I, LLC"),
    ("CTFTS", "Cityfunds I, LLC"),
    ...
    ("CTYDS", "Cityfunds I, LLC"),
    ("CTYFS", "Cityfunds I, LLC"),
    ("CUAUF", "C3 Metals Inc."),
    ...
    ("DBX", "DROPBOX, INC."),
    ("DC", "Dakota Gold Corp."),
    ("DCBG", "Dime Community Bancshares, Inc. /NY/"),
    ("DCBO", "Docebo Inc."),
    ("DCFBS", "DCFC Holdings, LLC"),
    ("DCGO", "DocGo Inc."),
    ("DCH", "Dauch Corp"),
    ("DCI", "DONALDSON Co INC"),
    ("DCO", "DUCOMMUN INC /DE/"),
    ("DCOM", "Dime Community Bancshares, Inc. /NY/"),
    ("DCOM-P", "Dime Community Bancshares, Inc. /NY/"),
    ...
    ("DHY-RI", "CREDIT SUISSE HIGH YIELD CREDIT FUND"),
    ...
    ("DOV", "DOVER Corp"),
    ("DOW", "DOW INC."),
    ("DOWAY", "Defeng Solife Holdings Limited/ADR"),
    ("DOX", "AMDOCS LTD"),
    ...
    ("EMCRF", "Embrace Change Acquisition Corp."),
    ("EMCWF", "Embrace Change Acquisition Corp."),
    ...
    ("ESHSF", "Eddy Smart Home Solutions Ltd."),
    ...
    ("GAING", "GLADSTONE INVESTMENT CORPORATION\\DE"),
    ...
    ("GDDY", "GoDaddy Inc."),
    ("GDEL", "Global Development Engineering Co Ltd"),
    ...
    ("GFTL", "Great Future Technology Inc."),
    ...
    ("GRAY", "Grayscale Investments, Inc."),
    ...
    ("GST", "Ga Sai Tong Enterprise Ltd"),
    ...
    ("HHLKF", "Hot Chili Ltd"),
    ("HHS", "HARTE HANKS INC"),
    ("HIFI", "Hillhouse Frontier Holdings Inc."),
    ...
    ("IPODW", "Dune Acquisition Corp II"),
    ("IPSAY", "IPSOS/ADR"),
    ...
    ("JLZQ", "Xiamen Customized Elf Technology Co., Ltd."),
    ("JMG", "JM Group Ltd"),
    ...
    ("KKRS", "KKR & Co. Inc."),
    ("KKRT", "KKR & Co. Inc."),
    ("KKSIY", "Kokusai Electric Corporation/ADR"),
    ("KLAC", "KLA CORP"),
    ...
    ("KOGDF", "KO Gold Inc."),
    ("KOKO", "KOKOBOTS GROUP"),
    ("KOKSF", "Kokusai Electric Corporation/ADR"),
    ...
    ("LABFF", "Laboratorios Farmaceuticos Rovi, S.A./ADR"),
    ("LABT", "Lakewood-Amedex Biotherapeutics Inc."),
    ("LAC", "LITHIUM AMERICAS CORP."),
    ("LACHF", "Lapco Holdings Limited/ADR"),
    ...
    ("LHI", "Living Homeopathy International Ltd."),
    ...
    ("LPCHY", "Lapco Holdings Limited/ADR"),
    ("LPCN", "Lipocine Inc."),
    ...
    ("LPSL", "Launchpad Streetlight Acquisition Corp"),
    ("LPSN", "LIVEPERSON INC"),
    ...
    ("LRVIY", "Laboratorios Farmaceuticos Rovi, S.A./ADR"),
    ...
    ("MCK", "MCKESSON CORP"),
    ("MCL", "Mclaren International Holdings Ltd"),
    ("MCLE", "Medicale Corp."),
    ...
    ("NFLX", "NETFLIX INC"),
    ("NFSN", "Nongfu Shop Digital New Retail Co., Ltd"),
    ...
    ("NOPFF", "Nevada Organic Phosphate Inc."),
    ...
    ("NPXYY", "Nippon Sanso Holdings Corporation/ADR"),
    ...
    ("NXG-RI", "NXG NextGen Infrastructure Income Fund"),
    ("NXGL", "NEXGEL, INC."),
    ("NXGLW", "NEXGEL, INC."),
    ...
    ("OSSFF", "Embla Medical HF/ADR"),
    ("OSSUY", "Embla Medical HF/ADR"),
    ...
    ("PASTF", "Plastic Omnium/ADR"),
    ("PASTY", "Plastic Omnium/ADR"),
    ...
    ("PAXG", "Pine Tree Acquisition Corp."),
    ...
    ("PDYTY", "PT Dayamitra Telekomunikasi Tbk/ADR"),
    ...
    ("PHDWY", "PT Ace Hardware Indonesia, Tbk./ADR"),
    ...
    ("PLMUF", "Plum Acquisition Corp. III"),
    ...
    ("POWMF", "Power Metal Resources PLC"),
    ...
    ("PRI", "Primerica, Inc."),
    ("PRIAF", "Prime Impact Acquisition I"),
    ...
    ("REDRF", "RED CANYON RESOURCES LTD."),
    ...
    ("RLFTF", "MindMaze Therapeutics Holding SA"),
    ...
    ("SBAQ", "Subversive Bitcoin Acquisition Corp."),
    ...
    ("SBEVW", "SPLASH BEVERAGE GROUP, INC."),
    ...
    ("SNPS", "SYNOPSYS INC"),
    ("SNPTF", "Sunny Optical Technology (Group) Co Limited/ADR"),
    ...
    ("SOS", "SOS Ltd"),
    ("SOTGY", "Sunny Optical Technology (Group) Co Limited/ADR"),
    ("SOTK", "SONO TEK CORP"),
    ...
    ("STBXF", "Starbox Group Holdings Ltd."),
    ...
    ("TRAXV", "First Tracks Biotherapeutics, Inc."),
    ("TRBG", "Turbogen Ltd."),
    ...
    ("TYNPF", "Nippon Sanso Holdings Corporation/ADR"),
    ...
    ("UHP", "Ultra High Point Holdings Ltd"),
    ...
    ("UNID", "RiverNorth Short Prime Unicorn Fund 2028, Inc"),
    ("UNIT", "Uniti Group Inc."),
    ("UNIU", "RiverNorth Long Prime Unicorn Fund 2028, Inc."),
    ...
    ("USPE", "Tap US Private Equity Fund of Funds"),
    ...
    ("VAII", "Voyager Acquisition Corp. II"),
    ("VAL", "Valaris Ltd"),
    ("VAL-WT", "Valaris Ltd"),
    ("VALE", "Vale S.A."),
    ("VALN", "Valneva SE"),
    ...
    ("VNTXF", "FORTE GROUP HOLDINGS INC."),
    ...
    ("VRXA", "Veraxa Biotech Holding AG"),
    ...
    ("WLGMF", "West Red Lake Gold Mines Ltd."),
    ...
    ("XINRY", "Xinyuan Real Estate Co., Ltd."),
    ...
    ("XXC", "XINXU COPPER INDUSTRY TECHNOLOGY Ltd"),
    ...
    ("YBZN", "Yi Po International Holdings Ltd"),
    ("YCBD", "cbdMD, Inc."),
    ...
    ("YOOV", "Concorde International Group Ltd."),
    ("YORW", "YORK WATER CO"),
    ...
    ("Z", "ZILLOW GROUP, INC."),
    ("ZAPPF", "Zapp Electric Vehicles Group Ltd"),
    ...
    ("ZSPC", "zSpace, Inc."),
    ("ZSQR", "Coeptis Therapeutics Holdings, Inc."),
    ("ZSTK", "ZeroStack Corp."),
    ("ZTEK", "Zentek Ltd."),
    ...
    ("ZTS", "Zoetis Inc."),
    ("ZTSTF", "ZTEST ELECTRONICS INC /FI"),
    ("ZUMZ", "Zumiez Inc"),
    ("ZURA", "Zura Bio Ltd"),
    ("ZVIA", "Zevia PBC"),
